...
set "catalog_hash_source=%library_dir%\com.unity.addressables\aa\Linux\catalog.hash"
set "catalog_json_source=%library_dir%\com.unity.addressables\aa\Linux\catalog.json"
set "settings_json_source=%library_dir%\com.unity.addressables\aa\Linux\settings.json"
set "dll_source=%library_dir%\ScriptAssemblies\%dll_name%"

set "initial_archive_name=%folder_name%.zip"
set "final_archive_name=%zip_name% %version_number% Linux.zip"
