...
set "catalog_hash_source=%library_dir%\com.unity.addressables\aa\OSX\catalog.hash"
set "catalog_json_source=%library_dir%\com.unity.addressables\aa\OSX\catalog.json"
set "settings_json_source=%library_dir%\com.unity.addressables\aa\OSX\settings.json"
set "dll_source=%library_dir%\ScriptAssemblies\%dll_name%"

set "initial_archive_name=%folder_name%.zip"
set "final_archive_name=%zip_name% %version_number% MacOS.zip"
